...
class ReviewAuditExpenseForPolicyViolationsAgent(K9ValidationLoopAgent):

    layer = "FinancialAnalysisAi ReviewAuditExpenseForPolicyViolationsAgent SBB"
    ...
    def finalize(self, loop_ctx: ValidationLoopContext) -> ValidationLoopResult:
        ...
        return ValidationLoopResult(
            ...
            output={
                "agent": "ReviewAuditExpenseForPolicyViolationsAgent",
